...
func handlingGame(writeInMyClientChan, writeToAnkamaServerChan chan messages.Message, myClientContinueChan, ankamaServerContinueChan chan bool, instance uint) func(*pack.Pipe) {
